...
<body id="top" class="bg-gray-100 text-gray-800 font-sans">
  ...
  <nav class="bg-white shadow-md fixed w-full top-0 z-30">
    <div class="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
      <!-- Judul klik = scroll ke atas -->
      <a href="#" onclick="window.scrollTo({ top: 0, behavior: 'smooth' });" class="text-xl font-bold text-blue-600 hover:text-blue-800 transition">CoralInteraction</a>
      <div class="space-x-4 hidden md:flex">
        ...
        <button onclick="window.location.href='terumbu_karang.php'" class="hover:text-blue-500 transition">Terumbu Karang</button>
  ...
  <section id="about" class="py-16 bg-white">
    <div class="max-w-4xl mx-auto px-4 text-center">
      <h2 class="text-3xl font-bold mb-4">About this website</h2>
  ...
  <section id="contact" class="py-16 bg-white">
    <div class="max-w-md mx-auto px-4">
      <h2 class="text-3xl font-bold mb-6 text-center text-blue-700">Log In</h2>

      <?php if (isset($_GET['error']) && $_GET['error'] == 1): ?>
        <p class="text-red-600 mb-4 text-center">Email/Username atau Password salah.</p>
      <?php endif; ?>

      <form action="login.php" method="POST" class="space-y-4">
        <input type="text" name="identifier" placeholder="Email atau Username" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-400" required />
        <input type="password" name="password" placeholder="Password" class="w-full px-4 py-2 border rounded-md focus:ring-2 focus:ring-blue-400" required />
        <div class="text-center">
          <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded hover:bg-blue-700 transition">Log In</button>
        </div>
      </form>
      ...
      <p class="text-center text-sm text-gray-600 mt-4">
        Belum punya akun? <a href="register.php" class="text-blue-600 hover:underline">Sign Up</a>
      </p>
    </div>
  </section>
